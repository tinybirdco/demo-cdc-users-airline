...
PG_CONFLUENT_CONNECTOR_NAME = 'PostgresDbzmConnector_0'
PG_DEBEZIUM_KAFKA_TOPIC = f"{PG_DATABASE}.public.{USERS_TABLE_NAME}"  # This structure is auto-generated by the Debezium connector, changing it may not work as expected
# See https://docs.confluent.io/cloud/current/connectors/cc-postgresql-cdc-source-debezium.html for more details
...
MYSQL_CONFLUENT_CONNECTOR_NAME = 'MysqlDbzmConnector_0'
MYSQL_DEBEZIUM_KAFKA_TOPIC = f"{MYSQL_DB_NAME}.{MYSQL_DB_NAME}.{USERS_TABLE_NAME}"  # This structure is auto-generated by the Debezium connector, changing it may not work as expected
# See https://docs.confluent.io/cloud/current/connectors/cc-mysql-source-cdc-debezium.html for more details
...
TINYBIRD_CONFLUENT_CONNECTION_NAME = 'cflt_cdc_demo'  # Friendly name to use in Tinybird for the Confluent Cloud connection.